// Vendored fork of https://github.com/httnn/nih-plug-webview (ISC).
// See NOTICE.md for local modifications.
...
impl Editor for WebViewEditor {
    fn spawn(
        ...
        let options = WindowOpenOptions {
            ...
            // Workspace baseview (rev 9a0b42c) builds with the `opengl`
            // feature via egui-baseview; the webview draws itself, so no
            // GL context is needed here.
            gl_config: None,
        };
